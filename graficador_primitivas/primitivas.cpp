//g++ primitivas.cpp -o m -lGL -lGLU -lglut
#include <GL/glut.h>  
#include <math.h>
...
int main(int argc, char** argv) {
    ...
    glutCreateWindow("primitivas OPENGL");//label de la ventana

    init();
    //glutDisplayFunc(modos); //visualizacion de una funcion
    //glutDisplayFunc(colores_interpolados); //visualizacion de una funcion
    //glutDisplayFunc(art); //visualizacion de una funcion
    //glutDisplayFunc(primitivas_opengl); //visualizacion de una funcion
    //glutDisplayFunc(patrones); //visualizacion de una funcion
